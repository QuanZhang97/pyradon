...
print("radon_l2c begins\n")
mil2,misfitl2 = pr.radon_l2c(Param,d,np.zeros(ma.shape),niter=N1,verb=1)
print("radon_l2c is done\n")

print("radon_l1c begins\n")
mil1,misfitl1 = pr.radon_l1c(Param,d,np.zeros(ma.shape),niter_in=N1,niter_out=3,verb=1)
print("radon_l1c is done\n")

# 
# 
# print("radon_l2 begins\n")
# mi2,misfit = pr.radon_l2(Param,d,np.zeros(ma.shape),niter=N1,verb=1)
# print("radon_l2 is done\n")
# 
# ## Adjoint
